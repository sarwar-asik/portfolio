      ...
      <div className="">
        <div className="grid grid-cols-3   gap-[20px] py-5  ">
          {services.map((service) => {
            return (
              <div class=" mx-auto flex w-[100%] gap-4 items-center  rounded-lg  shadow-md relative bg-red-40 hover:bg-slate-500">
                <figure className="">
                  <img
                    src={service.img}
                ...
                <div class="w-full bg-gray-200  rounded-full dark:bg-gray-700">
                  <div
                    class={`bg-${service?.color}-600 text-[10px] font-medium text-blue-100 text-center p-0.5 leading-none rounded-full`}
